    ...
    return (
        <>
            ...
            <div className={`flex flex-col items-center p-4 ${bgColor} min-h-screen relative`}>
                ...
                <div className={`${ButtonColor}  text-white rounded-2xl p-9 shadow-lg mt-12 w-full max-w-xl`}>
                ...
                <div className="flex gap-4 mt-4">
                    <button onClick={handleAlert} className={`${ButtonColor}  text-white px-6 py-4 rounded-lg shadow cursor-pointer`}>Recargar Balance</button>
                </div>
